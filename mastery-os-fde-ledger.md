...
* **Current State:** **1 of 17 rubrics calibrated**, and that number is now printed by `mastery check` on every invocation rather than buried in a ledger. The gap did not close. It became impossible to forget, and impossible to act past.
